...
<template>
  <nav class="">
    <ul class="flex justify-between text-white font-semibold">
      ...
      <li>
        <RouterLink to="/temperature-conversor">Temperature Conversor</RouterLink>
      </li>
      <li>
      ...
      <li>
        <RouterLink to="/circle-drawer">Circle Drawer</RouterLink>
      </li>
      <li>
        <RouterLink to="/cells">Cells</RouterLink>
      </li>
    </ul>
  </nav>
</template>
